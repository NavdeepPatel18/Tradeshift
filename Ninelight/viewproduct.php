    ...
    if (!isset($_SESSION['user'])) {
        ...
        if (isset($row_adder_id)) {
            if ($row_adder_id[2] == 2) {
                ...
                $sql = "SELECT product_name,product_weight,product_price_distributor FROM product";
                ...
                $sql = "SELECT product_name,product_weight,product_price_shopkeeper FROM product";
                $result = $conn->query($sql);
